...
export const ProtocolLegend = () => (
  <motion.div
    ...
    role="complementary"
    aria-label="Protocol legend"
  >
    <div className="inline-flex flex-wrap items-center justify-center gap-4 sm:gap-6 bg-card rounded-full shadow-md px-4 sm:px-6 py-3">
